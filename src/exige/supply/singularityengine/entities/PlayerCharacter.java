...
public enum PlayerCharacter {
    ...
    JACK(new Keyboard(new int[]{KeyEvent.VK_W, KeyEvent.VK_A, KeyEvent.VK_S, KeyEvent.VK_D, KeyEvent.VK_F, KeyEvent.VK_G, KeyEvent.VK_ESCAPE}), new Sprite(0, 1, 16, 11, 0, 3, SpritesManager.getInstance().getSheet(1))),
